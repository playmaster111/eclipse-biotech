window.DRUG_I18N = {
  "testosterone_suspension": {
    "de": {
      "name": "Testosteron (Kein Ester)",
      "overview": "Reines, unesterifiziertes Testosteron in Wasser- oder Ölbasis. Wirkt fast augenblicklich.",
      "primaryUses": "Schnelle Erhöhung des Testosteronspiegels.",
      "mechanism": "Gelangt sofort ins Blut. Erfordert tägliche Injektionen.",
      "dosage": "25mg bis 50mg i.m. täglich.",
      "risks": "Extreme Schmerzen an der Injektionsstelle, instabile Spiegel.",
      "benefits": "Sofortige Kraft- und Aggressionssteigerung.",
      "experimental": {
        "b": "50mg täglich",
        "a": "100mg täglich"
      }
    ...
    "es": {
      "name": "Testosterona (Sin Éster)",
      "overview": "Testosterona pura sin ester en base de agua o aceite. Actúa casi instantáneamente.",
      "primaryUses": "Elevación rápida de testosterona.",
      "mechanism": "Pasa instantáneamente a la sangre. Requiere inyecciones diarias.",
      "dosage": "25mg a 50mg IM diario.",
      "risks": "Dolor extremo en el sitio de inyección, niveles inestables.",
      "benefits": "Aumento inmediato de fuerza y agresión.",
      "experimental": {
        "b": "50mg diario",
        "a": "100mg diario"
      }
    ...
    "it": {
      "name": "Testosterone (Senza Estere)",
      "overview": "Testosterone puro non esterificato in base acquosa o oleosa. Agisce quasi istantaneamente.",
      "primaryUses": "Rapido aumento del testosterone.",
      "mechanism": "Passa istantaneamente nel sangue. Richiede iniezioni giornaliere.",
      "dosage": "25mg a 50mg IM al giorno.",
      "risks": "Dolore estremo nel sito di iniezione, livelli instabili.",
      "benefits": "Aumento immediato di forza e aggressività.",
      "experimental": {
        "b": "50mg al giorno",
        "a": "100mg al giorno"
      }
  ...
  "testosterone_enanthate": {
    "de": {
      ...
      "overview": "Langsam wirkender Ester des primären männlichen Androgens. Standard für TRT.",
      "primaryUses": "Hormonersatztherapie (Hypogonadismus).",
      "mechanism": "Bindet an den Androgenrezeptor. Der Enanthanat-Ester verzögert die Freisetzung.",
      "dosage": "100mg bis 200mg i.m. alle 7 bis 10 Tage.",
      "risks": "Aromatisierung zu Östrogen, Haarausfall, HPTA-Unterdrückung.",
      "benefits": "Stetiger Muskelaufbau, verbesserte Regeneration.",
      "experimental": {
        "b": "250mg alle 7 Tage",
        "a": "500mg+ wöchentlich"
      },
    ...
    "es": {
      ...
      "overview": "Éster de acción lenta de la testosterona primaria. Estándar para TRT.",
      "primaryUses": "Terapia de reemplazo hormonal (hipogonadismo).",
      "mechanism": "Se une al receptor de andrógenos. El éster de enantato retrasa la liberación.",
      "dosage": "100mg a 200mg IM cada 7 a 10 días.",
      "risks": "Aromatización a estrógenos, pérdida de cabello, supresión del HPTA.",
      "benefits": "Ganancia muscular constante, mejor recuperación.",
      "experimental": {
        "b": "250mg cada 7 días",
        "a": "500mg+ semanal"
      },
    ...
    "it": {
      ...
      "overview": "Estere a lenta azione del testosterone primario. Standard per la TRT.",
      "primaryUses": "Terapia ormonale sostitutiva (ipogonadismo).",
      "mechanism": "Si lega al recettore degli androgeni. L'estere enantato ritarda il rilascio.",
      "dosage": "100mg a 200mg IM ogni 7-10 giorni.",
      "risks": "Aromatizzazione in estrogeni, perdita di capelli, soppressione dell'HPTA.",
      "benefits": "Guadagno muscolare costante, miglioramento del recupero.",
      "experimental": {
        "b": "250mg ogni 7 giorni",
        "a": "500mg+ a settimana"
      },
      "synthesis": "Produced via the chemical conversion of plant-derived sterols.",
      "aestheticProfile": "Provides a look of overall muscle \"fullness\" and high density. At performance doses, it creates a \"thick\" appearance. Can cause a \"wet\" look (water retention) if estrogen is not managed.",
  ...
  "oxandrolone": {
    "de": {
      "overview": "Mildes orales Steroid, verschrieben bei schwerem Gewichtsverlust.",
      "primaryUses": "Verbrennungserholung, Turner-Syndrom.",
      "mechanism": "Schwach androgen, hoch anabol. Fördert den Gewebeerhalt.",
      "risks": "Lipidschäden (niedriges HDL), leichte Hepatotoxizität.",
      "benefits": "Kraftzuwachs ohne Wassereinlagerungen.",
      "experimental": {
        "b": "20mg täglich",
        "a": "50mg täglich"
      },
    ...
    "es": {
      "overview": "Esteroide oral suave, prescrito para la pérdida de peso severa.",
      "primaryUses": "Recuperación de quemaduras, síndrome de Turner.",
      "mechanism": "Débilmente androgénico, altamente anabólico. Promueve la retención de tejido.",
      "risks": "Alteración de lípidos (T-HDL bajo), toxicidad hepática leve.",
      "benefits": "Aumento de fuerza sin retención de agua.",
      "experimental": {
        "b": "20mg diario",
        "a": "50mg diario"
      },
    ...
    "it": {
      "overview": "Steroide orale blando, prescritto per la grave perdita di peso.",
      "primaryUses": "Recupero da ustioni, sindrome di Turner.",
      "mechanism": "Debolmente androgeno, altamente anabolizzante. Promuove la ritenzione tissutale.",
      "risks": "Alterazione dei lipidi (HDL basso), lieve epatotossicità.",
      "benefits": "Aumento della forza senza ritenzione idrica.",
      "experimental": {
        "b": "20mg al giorno",
        "a": "50mg al giorno"
      },
  ...
  "trenbolone_acetate": {
    "de": {
      "overview": "Extrem starkes veterinärmedizinisches Steroid. Nie für Menschen zugelassen.",
      "primaryUses": "Futterverwertung bei Rindern.",
      "mechanism": "5x stärker als Testosteron. Extreme Nährstoffverteilung.",
      "risks": "Herztoxizität, Nachtschweiß, Aggression, Nierenschäden.",
      "benefits": "Brutale Kraft, extreme Härte, Fettverlust.",
      "experimental": {
        "b": "50mg jeden zweiten Tag",
        "a": "100mg täglich"
      },
    ...
    "es": {
      "overview": "Esteroide veterinario extremadamente potente. Nunca aprobado para humanos.",
      "primaryUses": "Eficiencia de alimentación en ganado.",
      "mechanism": "5 veces más potente que la testosterona. Repartición de nutrientes extrema.",
      "risks": "Toxicidad cardíaca, sudores nocturnos, agresión, daño renal.",
      "benefits": "Fuerza brutal, dureza extrema, pérdida de grasa.",
      "experimental": {
        "b": "50mg cada dos días",
        "a": "100mg diario"
      },
      "dosage": "Administered via subcutaneous pellets in cattle.",
      "synthesis": "Synthesized through the reduction of 19-nortestosterone derivatives.",
    ...
    "it": {
      "overview": "Steroide veterinario estremamente potente. Mai approvato per l'uso umano.",
      "primaryUses": "Efficienza alimentare nel bestiame.",
      "mechanism": "5 volte più potente del testosterone. Ripartizione dei nutrienti estrema.",
      "risks": "Tossicità cardiaca, sudorazione notturna, aggressività, danno renale.",
      "benefits": "Forza brutale, durezza estrema, perdita di grasso.",
      "experimental": {
        "b": "50mg a giorni alterni",
        "a": "100mg al giorno"
      },
      "dosage": "Administered via subcutaneous pellets in cattle.",
      "synthesis": "Synthesized through the reduction of 19-nortestosterone derivatives.",
  ...
  "methandrostenolone": {
    "de": {
      "overview": "Bekannt als Dianabol, entwickelt für das US-Olympiateam.",
      "primaryUses": "Früher: Muskelschwund, sportliches Doping.",
      "mechanism": "Große Wasserretention und Masseaufbau durch starke Aromatisierung.",
      "risks": "Hoher Blutdruck, Lebertoxizität, extreme Blähungen.",
      "benefits": "Schneller Masse- und Kraftaufbau.",
      "experimental": {
        "b": "10mg täglich",
        "a": "50mg täglich"
      },
      "dosage": "5mg per day (historic).",
      "cycleExamples": "<strong>The Kickstart:</strong> Orals are commonly used as \"kickstarts\" for the first 4 weeks of an injectable cycle while the long esters build up. E.g., 30mg Dianabol täglich (Weeks 1-4) stacked with 500mg Testosterone (Weeks 1-12)."
    },
    "es": {
      "overview": "Conocido como Dianabol, desarrollado para el equipo olímpico de EE. UU.",
      "primaryUses": "Históricamente: Desgaste muscular, dopaje deportivo.",
      "mechanism": "Gran retención de agua y ganancia de masa por fuerte aromatización.",
      "risks": "Presión arterial alta, toxicidad hepática, hinchazón extrema.",
      "benefits": "Ganancia rápida de masa y fuerza.",
      "experimental": {
        "b": "10mg diario",
        "a": "50mg diario"
      },
      "dosage": "5mg per day (historic).",
      "cycleExamples": "<strong>The Kickstart:</strong> Orals are commonly used as \"kickstarts\" for the first 4 weeks of an injectable cycle while the long esters build up. E.g., 30mg Dianabol diario (Weeks 1-4) stacked with 500mg Testosterone (Weeks 1-12)."
    },
    "it": {
      "overview": "Noto come Dianabol, sviluppato per il team olimpico USA.",
      "primaryUses": "Storicamente: Deperimento muscolare, doping sportivo.",
      "mechanism": "Grande ritenzione idrica e guadagno di massa per forte aromatizzazione.",
      "risks": "Pressione sanguigna alta, tossicità epatica, gonfiore estremo.",
      "benefits": "Rapido guadagno di massa e forza.",
      "experimental": {
        "b": "10mg al giorno",
        "a": "50mg al giorno"
      },
      "dosage": "5mg per day (historic).",
      "cycleExamples": "<strong>The Kickstart:</strong> Orals sono commonly used as \"kickstarts\" for the first 4 weeks of an injectable cycle while the long esters build up. E.g., 30mg Dianabol al giorno (Weeks 1-4) stacked with 500mg Testosterone (Weeks 1-12)."
    }
  },
  "cannabis_indica": {
    "de": {
      "overview": "Cannabis-Sorten, die für ihre starke körperliche Sedierung und ihr 'Body High' bekannt sind. Typischerweise höherer Myrcengehalt.",
      "primaryUses": "Schlaflosigkeit, chronische Schmerzen, Muskelkrämpfe",
      "mechanism": "Wirkt als Agonist an CB1- und CB2-Rezeptoren im Endocannabinoid-System.",
      "dosage": "Variabel (5mg bis 100mg THC).",
      "benefits": "Tiefe Entspannung, Schlafinduktion, Appetitanregung.",
      "risks": "Lethargie, Couch-Lock, Beeinträchtigung des Kurzzeitgedächtnisses.",
      "synthesis": "Ursprünglich aus den kühleren Hochlagen des Hindukusch-Gebirges stammend. Indica-Pflanzen zeichnen sich durch ihren kurzen, buschigen Wuchs und breite Blätter aus.",
      "experimental": {
        "b": "Niedrige Dosis",
        "a": "Starke Benommenheit"
      }
    },
    "es": {
      "overview": "Variedades de cannabis conocidas por su fuerte sedación física y 'colocón corporal'. Típicamente con mayor contenido de mirceno.",
      "primaryUses": "Insomnio, dolor crónico, espasmos musculares",
      "mechanism": "Agoniza los receptores CB1 y CB2 en el sistema endocannabinoide.",
      "dosage": "Variable (5mg a 100mg THC).",
      "benefits": "Relajación profunda, inducción al sueño, estimulación del apetito.",
      "risks": "Letargo, efecto 'couch-lock', deterioro de la memoria a corto plazo.",
      "synthesis": "Originaria de los climas frescos de gran altitud de las montañas del Hindu Kush. Las plantas Indica se caracterizan por su baja estatura y hojas anchas.",
      "experimental": {
        "b": "Dosis baja",
        "a": "Estupefacción alta"
      }
    },
    "it": {
      "overview": "Varietà di cannabis note per la loro forte sedazione fisica e 'body high'. Tipicamente con un contenuto più elevato di mircene.",
      "primaryUses": "Insonnia, dolore cronico, spasmi muscolari",
      "mechanism": "Agonizza i recettori CB1 e CB2 nel sistema endocannabinoide.",
      "dosage": "Variabile (da 5mg a 100mg THC).",
      "benefits": "Profondo rilassamento, induzione del sonno, stimolazione dell'appetito.",
      "risks": "Letargia, effetto 'couch-lock', compromissione della memoria a breve termine.",
      "synthesis": "Originaria dei climi freschi ad alta quota delle montagne dell'Hindu Kush. Le piante Indica sono caratterizzate dalla loro statura bassa e foglie larghe.",
      "experimental": {
        "b": "Bassa dose",
        "a": "Forte stordimento"
      }
  ...
  "cannabis_sativa": {
    "de": {
      "overview": "Sativa-Sorten sind bekannt für ihre anregende, energetisierende Wirkung.",
      "primaryUses": "Depression, Müdigkeit, Fokus",
      "mechanism": "Agonist der CB1/CB2-Rezeptoren; reich an Limonen und Pinen.",
      "benefits": "Euphorie, Kreativitätssteigerung, Energie.",
      "experimental": {
        "b": "Kreativitäts-Boost",
        "a": "Hyper-Fokus"
      },
    ...
    "es": {
      "overview": "Las cepas sativa son conocidas por sus efectos estimulantes y energizantes.",
      "primaryUses": "Depresión, fatiga, enfoque",
      "mechanism": "Agonista de receptores CB1/CB2; rico en terpenos limoneno y pineno.",
      "benefits": "Euforia, aumento de creatividad, energía.",
      "experimental": {
        "b": "Impulso creativo",
        "a": "Hiper-enfoque"
      },
    ...
    "it": {
      "overview": "Le varietà Sativa sono note per i loro effetti stimolanti ed energizzanti.",
      "primaryUses": "Depressione, stanchezza, concentrazione",
      "mechanism": "Agonista dei recettori CB1/CB2; ricco di terpeni limonene e pinene.",
      "benefits": "Euforia, aumento della creatività, energia.",
      "experimental": {
        "b": "Spinta creativa",
        "a": "Iper-focus"
      },
      "risks": "Anxiety, paranoia, increased heart rate.",
      "dosage": "Variable.",
      "synthesis": "Originating from equatorial climates with long, hot growing seasons (e.g., Thailand, Mexico, Columbia). Sativa plants sono tall, thin-leaved, and take significantly longer to reach maturity compsonod to Indica. Their chemical profile is rich in invigorating terpenes like limonene and pinene."
    }
  },
  "thc": {
    "de": {
      "overview": "Der primäre psychoaktive Wirkstoff von Cannabis.",
      "primaryUses": "Schmerzlinderung, Übelkeit, Appetit.",
      "mechanism": "Bindet an CB1- und CB2-Rezeptoren im Gehirn.",
      "risks": "Paranoia, Gedächtnisstörungen.",
      "benefits": "Analgesie, Entspannung.",
      "experimental": {
        "b": "5-10mg",
        "a": "50mg+"
      }
    ...
    "es": {
      "overview": "El principal componente psicoactivo del cannabis.",
      "primaryUses": "Alivio del dolor, náuseas, apetito.",
      "mechanism": "Se une a los receptores CB1 y CB2 en el cerebro.",
      "risks": "Paranoia, deterioro de la memoria.",
      "benefits": "Analgesia, relajación.",
      "experimental": {
        "b": "5-10mg",
        "a": "50mg+"
      }
    ...
    "it": {
      "overview": "Il principale componente psicoattivo della cannabis.",
      "primaryUses": "Sollievo dal dolore, nausea, appetito.",
      "mechanism": "Si lega ai recettori CB1 e CB2 nel cervello.",
      "risks": "Paranoia, compromissione della memoria.",
      "benefits": "Analgesia, rilassamento.",
      "experimental": {
        "b": "5-10mg",
        "a": "50mg+"
      }
  ...
  "mdma": {
    "de": {
      "overview": "3,4-Methylendioxy-N-methylamphetamin. Bekannt für empathogene Wirkung.",
      "primaryUses": "Experimentell: PTBS-Therapie.",
      "mechanism": "Massive Freisetzung von Serotonin, Dopamin und Noradrenalin.",
      "risks": "Neurotoxizität, Dehydrierung, Depression nach dem Konsum.",
      "benefits": "Empathie, emotionale Offenheit.",
      "experimental": {
        "b": "100mg",
        "a": "150mg"
      },
    ...
    "es": {
      "overview": "3,4-metilendioximetanfetamina. Conocida por sus efectos empatógenos.",
      "primaryUses": "Experimental: Terapia para el TEPT.",
      "mechanism": "Liberación masiva de serotonina, dopamina y norepinefrina.",
      "risks": "Neurotoxicidad, deshidratación, depresión post-consumo.",
      "benefits": "Empatía, apertura emocional.",
      "experimental": {
        "b": "100mg",
        "a": "150mg"
      },
    ...
    "it": {
      "overview": "3,4-metilendiossimetanfetamina. Nota per i suoi effetti empatogeni.",
      "primaryUses": "Sperimentale: Terapia per il PTSD.",
      "mechanism": "Rilascio massiccio di serotonina, dopamina e noradrenalina.",
      "risks": "Neurotossicità, disidratazione, depressione post-consumo.",
      "benefits": "Empatia, apertura emotiva.",
      "experimental": {
        "b": "100mg",
        "a": "150mg"
      },
  ...
  "cocaine": {
    "de": {
      "overview": "Starkes Stimulans aus den Blättern der Coca-Pflanze.",
      "primaryUses": "Früher: Lokalanästhetikum.",
      "mechanism": "Blockiert die Wiederaufnahme von Dopamin, Serotonin und Noradrenalin.",
      "risks": "Herzstillstand, Sucht, psychischer Zusammenbruch.",
      "benefits": "Extremes Selbstvertrauen, Energie.",
      "experimental": {
        "b": "50mg",
        "a": "Binge-Nutzung"
      },
    ...
    "es": {
      "overview": "Potente estimulante obtenido de las hojas de la planta de coca.",
      "primaryUses": "Históricamente: Anestésico local.",
      "mechanism": "Bloquea la recaptación de dopamina, serotonina y norepinefrina.",
      "risks": "Paro cardíaco, adicción, colapso psicológico.",
      "benefits": "Confianza extrema, energía.",
      "experimental": {
        "b": "50mg",
        "a": "Uso en atracones"
      },
    ...
    "it": {
      "overview": "Potente stimolante ottenuto dalle foglie della pianta di coca.",
      "primaryUses": "Storicamente: Anestetico locale.",
      "mechanism": "Blocca la ricaptazione di dopamina, serotonina e norepinefrina.",
      "risks": "Arresto cardiaco, dipendenza, crollo psicologico.",
      "benefits": "Fiducia estrema, energia.",
      "experimental": {
        "b": "50mg",
        "a": "Uso compulsivo"
      },
  ...
  "lsd": {
    "de": {
      "overview": "Lysergsäurediethylamid. Eines der stärksten Psychedelika.",
      "primaryUses": "Forschung, Psychotherapie.",
      "mechanism": "Wirkt als Agonist am 5-HT2A Serotoninrezeptor.",
      "risks": "HPPD, Psychosen bei Veranlagung, Bad Trips.",
      "benefits": "Tiefe Selbsterkenntnis, Neuroplastizität.",
      "experimental": {
        "b": "50-100mcg",
        "a": "300mcg+"
      },
      ...
      "cycleExamples": "<strong>Microdosing:</strong> 10mcg taken alle 3rd day for cognitive enhancement and mood stabilization."
    },
    "es": {
      "overview": "Dietilamida del ácido lisérgico. Uno de los psicodélicos más potentes.",
      "primaryUses": "Investigación, psicoterapia.",
      "mechanism": "Actúa como agonista en el receptor de serotonina 5-HT2A.",
      "risks": "HPPD, psicosis en predispuestos, malos viajes.",
      "benefits": "Introspección profunda, neuroplasticidad.",
      "experimental": {
        "b": "50-100mcg",
        "a": "300mcg+"
      },
      "dosage": "50mcg to 200mcg (1-2 tabs).",
      "synthesis": "Semi-synthesized from lysergic acid derived from ergot fungus.",
      "cycleExamples": "<strong>Microdosing:</strong> 10mcg taken cada 3rd day for cognitive enhancement and mood stabilization."
    },
    "it": {
      "overview": "Dietilamide dell'acido lisergico. Uno dei psichedelici più potenti.",
      "primaryUses": "Ricerca, psicoterapia.",
      "mechanism": "Agisce come agonista del recettore della serotonina 5-HT2A.",
      "risks": "HPPD, psicosi in soggetti predisposti, bad trip.",
      "benefits": "Profonda introspezione, neuroplasticità.",
      "experimental": {
        "b": "50-100mcg",
        "a": "300mcg+"
      },
      "dosage": "50mcg to 200mcg (1-2 tabs).",
      "synthesis": "Semi-synthesized from lysergic acid derived from ergot fungus.",
      "cycleExamples": "<strong>Microdosing:</strong> 10mcg taken ogni 3rd day for cognitive enhancement and mood stabilization."
    }
  },
  "clenbuterol": {
    "de": {
      "overview": "Beta-2-Agonist zur Asthmabehandlung, stark fettverbrennend.",
      "primaryUses": "Asthma, Fettverbrennung.",
      "mechanism": "Erhöht die Körpertemperatur und den Stoffwechsel.",
      "risks": "Herzklopfen, Muskelkrämpfe, Hypertrophie.",
      "benefits": "Extreme Thermogenese, Muskelerhalt beim Diäten.",
      "experimental": {
        "b": "20mcg täglich",
        "a": "120mcg+ täglich"
      },
    ...
    "es": {
      "overview": "Agonista beta-2 para el asma, potente quemador de grasa.",
      "primaryUses": "Asma, quema de grasa.",
      "mechanism": "Aumenta la temperatura corporal y el metabolismo.",
      "risks": "Palpitaciones, calambres, hipertrofia cardíaca.",
      "benefits": "Termogénesis extrema, preservación muscular.",
      "experimental": {
        "b": "20mcg diario",
        "a": "120mcg+ diario"
      },
    ...
    "it": {
      "overview": "Agonista beta-2 per l'asma, potente bruciagrassi.",
      "primaryUses": "Asma, combustione dei grassi.",
      "mechanism": "Aumenta la temperatura corporea e il metabolismo.",
      "risks": "Palpitazioni, crampi, ipertrofia cardiaca.",
      "benefits": "Termogenesi estrema, preservazione muscolare.",
      "experimental": {
        "b": "20mcg al giorno",
        "a": "120mcg+ al giorno"
      },
  ...
  "hgh_somatropin": {
    "de": {
      "overview": "Synthetisches menschliches Wachstumshormon.",
      "primaryUses": "HGH-Mangel, Kleinwuchs.",
      "mechanism": "Stimuliert die IGF-1-Produktion in der Leber.",
      "risks": "Insulinresistenz, Organvergrößerung.",
      "benefits": "Fettverbrennung, verbesserte Schlafqualität, Heilung.",
      "experimental": {
        "b": "2-4 I.E. täglich",
        "a": "8-10 I.E. täglich"
      },
      "dosage": "1 IU to 3 IU täglich (Medical).",
    ...
    "es": {
      "overview": "Hormona de crecimiento humano sintética.",
      "primaryUses": "Deficiencia de HGH, baja estatura.",
      "mechanism": "Estimula la producción de IGF-1 en el hígado.",
      "risks": "Resistencia a la insulina, organomegalia.",
      "benefits": "Pérdida de grasa, mejor sueño, curación.",
      "experimental": {
        "b": "2-4 UI diario",
        "a": "8-10 UI diario"
      },
      "dosage": "1 IU to 3 IU diario (Medical).",
      "aestheticProfile": "Provides a \"youthful\" glow to the skin. Causes a distinct look of \"fullness\" and \"roundness\" to the muscles. Long-term high doses can lead to \"HGH Gut\" (distended abdomen).",
      "physiologicalTargets": "Systemic cellular impact. Targets the liver for IGF-1 conversion and directly affects adipose tissue for fat mobilization."
    },
    "it": {
      "overview": "Ormone della crescita umano sintetico.",
      "primaryUses": "Deficienza di HGH, bassa statura.",
      "mechanism": "Stimola la produzione di IGF-1 nel fegato.",
      "risks": "Resistenza all'insulina, organomegalia.",
      "benefits": "Perdita di grasso, miglior sonno, guarigione.",
      "experimental": {
        "b": "2-4 UI al giorno",
        "a": "8-10 UI al giorno"
      },
      "dosage": "1 IU to 3 IU al giorno (Medical).",
      "aestheticProfile": "Provides a \"youthful\" glow to the skin. Causes a distinct look of \"fullness\" and \"roundness\" to the muscles. Long-term high doses can lead to \"HGH Gut\" (distended abdomen).",
      "physiologicalTargets": "Systemic cellular impact. Targets the liver for IGF-1 conversion and directly affects adipose tissue for fat mobilization."
    }
  },
  "boldenone": {
    "de": {
      "overview": "Veterinärmedizinisches Steroid für Pferde. Sorgt für stetige, trockene Zuwächse.",
      "primaryUses": "Appetitsteigerung bei Tieren.",
      "mechanism": "Aromatisiert nur zu 50% wie Testosteron. Erhöht rote Blutkörperchen.",
      "risks": "Hämatokrit-Erhöhung, Angstzustände.",
      "benefits": "Erhöhte Ausdauer, gesteigerter Appetit.",
      "experimental": {
        "b": "400mg wöchentlich",
        "a": "800mg+ wöchentlich"
      },
      "dosage": "Administered via IM in equines.",
      "cycleExamples": "<strong>The Slow Gainer:</strong> Boldenone is typically run for long durations (16-20 weeks) due to the extremely long Undecylenate ester. A common protocol is 600mg Equipoise / 500mg Testosterone wöchentlich."
    },
    "es": {
      "overview": "Esteroide veterinario para caballos. Ganancias constantes y secas.",
      "primaryUses": "Aumento del apetito en animales.",
      "mechanism": "Aromatiza solo el 50% que la testosterona. Aumenta glóbulos rojos.",
      "risks": "Elevación del hematocrito, ansiedad.",
      "benefits": "Mayor resistencia, aumento del apetito.",
      "experimental": {
        "b": "400mg semanal",
        "a": "800mg+ semanal"
      },
      "dosage": "Administered via IM in equines.",
      "cycleExamples": "<strong>The Slow Gainer:</strong> Boldenone is typically run for long durations (16-20 weeks) due to the extremely long Undecylenate ester. A common protocol is 600mg Equipoise / 500mg Testosterone semanal."
    },
    "it": {
      "overview": "Steroide veterinario per cavalli. Guadagni costanti e secchi.",
      "primaryUses": "Aumento dell'appetito negli animali.",
      "mechanism": "Aromatizza solo il 50% rispetto al testosterone. Aumenta i globuli rossi.",
      "risks": "Elevazione dell'ematocrito, ansia.",
      "benefits": "Maggiore resistenza, aumento dell'appetito.",
      "experimental": {
        "b": "400mg a settimana",
        "a": "800mg+ a settimana"
      },
      "dosage": "Administered via IM in equines.",
      "cycleExamples": "<strong>The Slow Gainer:</strong> Boldenone is typically run for long durations (16-20 weeks) due to the extremely long Undecylenate ester. A common protocol is 600mg Equipoise / 500mg Testosterone a settimana."
    }
  },
  "nandrolone_decanoate": {
    "de": {
      "overview": "Langsam wirkender 19-nor-AAS, bekannt für Gelenkschmierung.",
      "primaryUses": "Anämie, Osteoporose.",
      "mechanism": "Bindet stark an Progesteronrezeptoren. Geringe Aromatisierung.",
      "risks": "Deca-Dick (Libidoverlust), HPTA-Abschaltung.",
      "benefits": "Gelenkschmerzlinderung, massiver Masseaufbau.",
      "experimental": {
        "b": "200mg wöchentlich",
        "a": "600mg+ wöchentlich"
      },
      "dosage": "50mg to 100mg IM alle 3-4 weeks.",
      ...
      "cycleExamples": "<strong>The Classic Mass Builder:</strong> Historically stacked alongside a testosterone base to mitigate libido crash. E.g., 500mg Testosterone / 300mg Deca-Durabolin wöchentlich for 16 weeks."
    },
    "es": {
      "overview": "AAS de tipo 19-nor de acción lenta, conocido por lubricar las articulaciones.",
      "primaryUses": "Anemia, osteoporosis.",
      "mechanism": "Se une fuertemente a receptores de progesterona. Baja aromatización.",
      "risks": "Deca Dick (pérdida de libido), cierre del HPTA.",
      "benefits": "Alivio del dolor articular, ganancia de masa masiva.",
      "experimental": {
        "b": "200mg semanal",
        "a": "600mg+ semanal"
      },
      "dosage": "50mg to 100mg IM cada 3-4 weeks.",
      "aestheticProfile": "Provides a \"soft\" but massive look. Muscles appear smooth and watery, but extremely large. Yields a very \"thick\" appearance in the back and legs.",
      "physiologicalTargets": "Targets the synovial fluid in joints (therapeutic) and the mu-opioid receptors (indirectly, via pain suppression). High affinity for skeletal muscle hypertrophy.",
      "cycleExamples": "<strong>The Classic Mass Builder:</strong> Historically stacked alongside a testosterone base to mitigate libido crash. E.g., 500mg Testosterone / 300mg Deca-Durabolin semanal for 16 weeks."
    },
    "it": {
      "overview": "AAS di tipo 19-nor a lenta azione, noto per la lubrificazione articolare.",
      "primaryUses": "Anemia, osteoporosi.",
      "mechanism": "Si lega fortemente ai recettori del progesterone. Bassa aromatizzazione.",
      "risks": "Deca Dick (perdita di libido), spegnimento HPTA.",
      "benefits": "Sollievo dal dolore articolare, guadagno di massa massiccio.",
      "experimental": {
        "b": "200mg a settimana",
        "a": "600mg+ a settimana"
      },
      "dosage": "50mg to 100mg IM ogni 3-4 weeks.",
      "aestheticProfile": "Provides a \"soft\" but massive look. Muscles appear smooth and watery, but extremely large. Yields a very \"thick\" appearance in the back and legs.",
      "physiologicalTargets": "Targets the synovial fluid in joints (therapeutic) and the mu-opioid receptors (indirectly, via pain suppression). High affinity for skeletal muscle hypertrophy.",
      "cycleExamples": "<strong>The Classic Mass Builder:</strong> Historically stacked alongside a testosterone base to mitigate libido crash. E.g., 500mg Testosterone / 300mg Deca-Durabolin a settimana for 16 weeks."
    }
  },
  "dnp": {
    "de": {
  ...
  "t3_cytomel": {
    "de": {
      ...
      "cycleExamples": "<strong>Metabolic Support:</strong> 25mcg täglich run alongside an anabolic cycle to offset the thyroid suppression often caused by HGH or Trenbolone.",
      "experimental": {
        "b": "25mcg/day",
        "a": "75-100mcg/day"
      }
    ...
    "es": {
      ...
      "cycleExamples": "<strong>Metabolic Support:</strong> 25mcg diario run alongside an anabolic cycle to offset the thyroid suppression often caused by HGH or Trenbolone.",
      "experimental": {
        "b": "25mcg/day",
        "a": "75-100mcg/day"
      }
    ...
    "it": {
      ...
      "cycleExamples": "<strong>Metabolic Support:</strong> 25mcg al giorno run alongside an anabolic cycle to offset the thyroid suppression often caused by HGH or Trenbolone.",
      "experimental": {
        "b": "25mcg/day",
        "a": "75-100mcg/day"
      }
  ...
  "oxymetholone": {
    "de": {
      "overview": "Bekannt als Anadrol. Eines der stärksten oralen Masse-Steroide.",
      "benefits": "Extremer Kraftzuwachs, massive Glykogenfüllung, rasante Massesteigerung.",
      "risks": "Schwere Hepatotoxizität, extremer Bluthochdruck, Östrogen-Nebenwirkungen.",
      ...
      "primaryUses": "Schwere Anämie, HIV/AIDS wasting",
    ...
    "es": {
      "overview": "Conocido como Anadrol. Uno de los esteroides orales más potentes para ganar masa.",
      "benefits": "Aumento extremo de fuerza, llenado masivo de glucógeno, rápida ganancia de peso.",
      "risks": "Hepatotoxicidad severa, presión arterial muy alta, efectos estrogénicos.",
      "mechanism": "Potent 17aa oral. Drastically stimulates erythropoiesis via enhanced production of erythropoietin. Does not aromatize but still activates estrogen receptors directly.",
      "primaryUses": "Anemia severa, HIV/AIDS wasting",
      "dosage": "1mg to 5mg per kg of bodyweight per day.",
      "experimental": {
        "b": "25–50 mg/day",
        "a": "75–100 mg/day"
    ...
    "it": {
      "overview": "Noto come Anadrol. Uno degli steroidi orali più potenti per la massa muscolare.",
      "benefits": "Incremento estremo di forza, volumizzazione massiccia di glicogeno, rapido aumento di peso.",
      "risks": "Grave epatotossicità, forte aumento della pressione sanguigna, effetti estrogenici.",
      "mechanism": "Potent 17aa oral. Drastically stimulates erythropoiesis via enhanced production of erythropoietin. Does not aromatize but still activates estrogen receptors directly.",
      "primaryUses": "Grave anemia, HIV/AIDS wasting",
      "dosage": "1mg to 5mg per kg of bodyweight per day.",
      "experimental": {
        "b": "25–50 mg/day",
        "a": "75–100 mg/day"
  ...
  "stanozolol": {
    "de": {
      "overview": "Winstrol. DHT-Derivat für maximale Härte und Vaskularität.",
      "benefits": "Trockene Muskelmasse, senkt SHBG drastisch, steigert freies Testosteron.",
      "risks": "Austrocknung der Gelenke (Gelenkschmerzen), schwere Lipidverschlechterung, Leberschäden.",
    ...
    "es": {
      "overview": "Winstrol. Derivado de DHT para máxima dureza y vascularidad.",
      "benefits": "Masa muscular magra y seca, reduce drásticamente SHBG, aumenta testosterona libre.",
      "risks": "Dolor y sequedad articular, daño en perfil lipídico, hepatotoxicidad.",
      "mechanism": "Decreases frequency and severity of angioedema swelling attacks by increasing the production of C1-inhibitor.",
      "primaryUses": "Hereditary angioedema",
      "dosage": "2mg oral, three times per day.",
      "aestheticProfile": "Creates a \"paper-thin\" skin appearance by flushing out subcutaneous water. Extreme vascularity (veins like \"garden hoses\"). Provides a \"3D\" look to the delts and traps.",
    ...
    "it": {
      "overview": "Winstrol. Derivato del DHT per la massima definizione e vascolarizzazione.",
      "benefits": "Massa muscolare asciutta e definita, riduce drasticamente l'SHBG, aumenta il testosterone libero.",
      "risks": "Secchezza e dolori articolari, alterazione severa dei lipidi, tossicità epatica.",
      "mechanism": "Decreases frequency and severity of angioedema swelling attacks by increasing the production of C1-inhibitor.",
      "primaryUses": "Hereditary angioedema",
      "dosage": "2mg oral, three times per day.",
      "aestheticProfile": "Creates a \"paper-thin\" skin appearance by flushing out subcutaneous water. Extreme vascularity (veins like \"garden hoses\"). Provides a \"3D\" look to the delts and traps.",
  ...
  "cardarine": {
    "de": {
      "overview": "PPAR-Delta-Agonist zur radikalen Steigerung von Ausdauer und Fettverbrennung.",
      "benefits": "Enorme Steigerung der kardiovaskulären Ausdauer, verbessert HDL-Cholesterin.",
      "risks": "Potenzielle Kanzerogenität in Nagetierstudien bei hohen Dosen.",
    ...
    "es": {
      "overview": "Agonista de PPAR-delta para aumentar radicalmente la resistencia y la quema de grasa.",
      "benefits": "Aumento masivo de la resistencia cardiovascular, mejora del colesterol HDL.",
      "risks": "Posible carcinogenicidad observada en estudios con roedores a dosis elevadas.",
      "mechanism": "Binds exclusively to the PPARδ receptor, radically altering genetic output to force the body to burn fat for fuel instead of carbohydrates.",
      "primaryUses": "Historical endurance research",
      "dosage": "Not medically approved.",
      "cycleExamples": "<strong>Endurance Support:</strong> 10mg taken 30 minutes before cardio to radically increase lung capacity and duration.",
    ...
    "it": {
      "overview": "Agonista PPAR-delta per aumentare radicalmente la resistenza aerobica e l'ossidazione dei grassi.",
      "benefits": "Enorme aumento della resistenza cardiovascolare, miglioramento del colesterolo HDL.",
      "risks": "Potenziale cancerogenicità evidenziata in studi su roditori a dosaggi elevati.",
      "mechanism": "Binds exclusively to the PPARδ receptor, radically altering genetic output to force the body to burn fat for fuel instead of carbohydrates.",
      "primaryUses": "Historical endurance research",
      "dosage": "Not medically approved.",
      "cycleExamples": "<strong>Endurance Support:</strong> 10mg taken 30 minutes before cardio to radically increase lung capacity and duration.",
  ...
  "bpc157": {
    "de": {
      "overview": "Synthetisches Peptid aus dem Magensaft für beschleunigte Gewebeheilung.",
      "benefits": "Beschleunigt die Heilung von Sehnen, Bändern, Muskeln und Darmschleimhaut.",
      "risks": "Minimal; gelegentlich Rötung an der Injektionsstelle.",
      ...
      "experimental": {
        "b": "250mcg twice täglich",
        "a": "500mcg twice täglich"
      }
    },
    "es": {
      "overview": "Péptido derivado de jugo gástrico para acelerar la reparación de tejidos.",
      "benefits": "Reparación acelerada de tendones, ligamentos, tejido muscular y mucosa gástrica.",
      "risks": "Mínimos; ocasional irritación en el sitio de inyección.",
      "mechanism": "Dramatically upregulates VEGFR2 (angiogenesis) which forms new blood vessels around torn cartilage and tendons, accelerating healing permanently.",
      "primaryUses": "Experimental injury recovery",
      "dosage": "Not clinically approved.",
      "cycleExamples": "<strong>Injury Protocol:</strong> 250mcg injected subcutaneously as close to the injury site as possible, twice a day for 4-6 weeks.",
      "experimental": {
        "b": "250mcg twice diario",
        "a": "500mcg twice diario"
      }
    },
    "it": {
      "overview": "Peptide derivato dal succo gastrico per accelerare la guarigione dei tessuti.",
      "benefits": "Guarigione accelerata di tendini, legamenti, muscoli e mucosa intestinale.",
      "risks": "Minimi; occasionale arrossamento nel punto di iniezione.",
      "mechanism": "Dramatically upregulates VEGFR2 (angiogenesis) which forms new blood vessels around torn cartilage and tendons, accelerating healing permanently.",
      "primaryUses": "Experimental injury recovery",
      "dosage": "Not clinically approved.",
      "cycleExamples": "<strong>Injury Protocol:</strong> 250mcg injected subcutaneously as close to the injury site as possible, twice a day for 4-6 weeks.",
      "experimental": {
        "b": "250mcg twice al giorno",
        "a": "500mcg twice al giorno"
      }
    }
  },
  "nandrolone_npp": {
    "it": {
      ...
      "overview": "L'NPP è la forma estere di nandrolone ad azione rapida. Viene eliminato dal sistema molto più rapidamente del Deca, rendendo gli effetti collaterali molto più facili da mitigare qualora si manifestino.",
      "mechanism": "Identico al decanoato, ma provvisto di un estere a catena molto più corta, riducendo l'emivita da 15 giorni a circa 4-5 giorni.",
      "primaryUses": "Controllo del carcinoma mammario, grave osteoporosi",
      "dosage": "Da 50mg a 100mg IM a settimana.",
      "benefits": "Viene eliminato rapidamente dall'organismo se compaiono effetti collaterali; profilo terapeutico identico al Deca con un ritardo di recupero dell'asse HPTA significativamente inferiore a lungo termine.",
      "risks": "Innalzamento della prolattina, sovraccarico cardiovascolare, grave soppressione dell'HPTA.",
      "cycleExamples": "<strong>Supporto per cicli brevi:</strong> Spesso preferito per cicli più brevi (8-10 settimane) in cui il Deca è poco pratico a causa del suo tempo di eliminazione prolungato."
    },
    "de": {
      "name": "Nandrolon-Phenylpropionat",
      "overview": "NPP ist die schneller wirkende Esterform von Nandrolon. Es wird wesentlich schneller abgebaut, wodurch Nebenwirkungen bei Auftreten leichter beherrschbar sind.",
      "mechanism": "Identisch mit Decanoat, trägt jedoch einen viel kürzeren Ester, wodurch die Halbwertszeit von 15 Tagen auf etwa 4-5 Tage verkürzt wird.",
      "primaryUses": "Brustkrebsbehandlung, schwere Osteoporose",
      "dosage": "50mg bis 100mg i.m. wöchentlich.",
      "benefits": "Schnelle Ausscheidung aus dem Körper bei Auftreten von Nebenwirkungen; identisches therapeutisches Profil wie Deca mit deutlich geringerer langfristiger HPTA-Unterdrückungsverzögerung.",
      "risks": "Prolaktinerhöhung, kardiovaskuläre Belastung, schwere HPTA-Unterdrückung.",
      "cycleExamples": "<strong>Unterstützung für kurze Kuren:</strong> Häufig für kürzere Zyklen (8-10 Wochen) bevorzugt, bei denen Deca aufgrund seiner langen Halbwertszeit unpraktisch ist."
    },
    "es": {
      "name": "Fenilpropionato de Nandrolona",
      "overview": "El NPP es la forma éster de acción más rápida de la nandrolona. Se elimina del organismo mucho más rápido, lo que facilita mitigar los efectos secundarios si aparecen.",
      "mechanism": "Idéntico al decanoato pero con un éster mucho más corto, reduciendo la vida media de 15 días a aproximadamente 4-5 días.",
      "primaryUses": "Control del cáncer de mama, osteoporosis severa",
      "dosage": "50mg a 100mg IM semanalmente.",
      "benefits": "Se elimina rápidamente del cuerpo si se manifiestan efectos secundarios; perfil terapéutico idéntico al Deca con un retraso en la recuperación del eje HPTA significativamente menor a largo plazo.",
      "risks": "Elevación de prolactina, sobrecarga cardiovascular, supresión severa del eje HPTA.",
      "cycleExamples": "<strong>Soporte para ciclos cortos:</strong> Frecuentemente preferido para ciclos más cortos (8-10 semanas) donde el Deca resulta impráctico debido a su tiempo de aclaramiento extremadamente largo."
    }
  },
  "sustanon": {
    "it": {
      "name": "Sustanon 250",
      "overview": "Una miscela formulata con precisione di quattro distinti esteri di testosterone, originariamente sviluppata da Organon per fornire un rilascio ormonale sia rapido che prolungato.",
      "mechanism": "Combina propionato, fenilpropionato, isocaproato e decanoato. Raggiunge un picco rapido entro 24-48 ore mantenendo livelli ematici stabili fino a 2-3 settimane.",
      "primaryUses": "Terapia ormonale sostitutiva (TRT), ipogonadismo primario",
      "dosage": "250mg IM ogni 2-3 settimane (TRT clinica).",
      "benefits": "Eccellente versatilità anabolica, elevato guadagno di forza e massa muscolare, livelli ormonali costanti senza picchi isolati.",
      "risks": "Aromatizzazione in estradiolo, ritenzione idrica, soppressione endogena dell'HPTA, aumento dell'ematocrito.",
      "cycleExamples": "<strong>La base classica:</strong> 500mg a settimana suddivisi in due somministrazioni da 250mg per 12-16 settimane."
    },
    "de": {
      "name": "Sustanon 250",
      "overview": "Eine präzise formulierte Mischung aus vier verschiedenen Testosteronestern, ursprünglich von Organon entwickelt, um sowohl eine schnelle als auch eine langanhaltende Hormonfreisetzung zu gewährleisten.",
      "mechanism": "Kombiniert Propionat, Phenylpropionat, Isocaproat und Decanoat. Schneller Wirkungseintritt innerhalb von 24-48 Stunden bei gleichmäßiger Wirkung über 2-3 Wochen.",
      "primaryUses": "Hormonersatztherapie (TRT), primärer Hypogonadismus",
      "dosage": "250mg i.m. alle 2-3 Wochen (klinisch).",
      "benefits": "Ausgezeichneter Kraft- und Muskelzuwachs, konstante Hormonspiegel ohne starke Einbrüche, verbesserte Regeneration.",
      "risks": "Aromatisierung zu Östrogen, Wassereinlagerungen, HPTA-Unterdrückung, Hämatokritanstieg.",
      "cycleExamples": "<strong>Klassische Masse-Basis:</strong> 500mg pro Woche aufgeteilt in zwei Gaben über 12-16 Wochen."
    },
    "es": {
      "name": "Sustanon 250",
      "overview": "Una mezcla formulada con precisión de cuatro ésteres distintos de testosterona, desarrollada originalmente por Organon para proporcionar una liberación hormonal tanto inmediata como prolongada.",
      "mechanism": "Combina propionato, fenilpropionato, isocaproato y decanoato. Pico rápido en 24-48 horas con niveles estables durante 2-3 semanas.",
      "primaryUses": "Terapia de reemplazo de testosterona (TRT), hipogonadismo",
      "dosage": "250mg IM cada 2-3 semanas (TRT clínica).",
      "benefits": "Ganancias constantes de masa y fuerza, estabilidad hormonal sostenida, mejora notable en recuperación física.",
      "risks": "Aromatización a estrógenos, retención de líquidos, supresión del HPTA, aumento del hematocrito.",
      "cycleExamples": "<strong>Base clásica de volumen:</strong> 500mg por semana divididos en dos inyecciones de 250mg durante 12-16 semanas."
    }
  },
  "testosterone_cypionate": {
    "it": {
      "name": "Testosterone Cipionato",
      "overview": "La formulazione iniettabile di testosterone più comunemente prescritta negli Stati Uniti per la terapia sostitutiva (TRT).",
      "mechanism": "Estere a catena di 8 carboni con un'emivita di circa 8 giorni. Si lega ai recettori degli androgeni promuovendo sintesi proteica e ritenzione di azoto.",
    ...
    "de": {
      ...
      "overview": "Das in den USA am häufigsten verschriebene injizierbare Testosteron für die Hormonersatztherapie.",
      "mechanism": "8-Kohlenstoff-Ester mit einer Halbwertszeit von ca. 8 Tagen. Bindet an Androgenrezeptoren und fördert die Proteinsynthese.",
    ...
    "es": {
      ...
      "overview": "La formulación de testosterona inyectable más recetada en los Estados Unidos para terapia de reemplazo hormonal (TRT).",
      "mechanism": "Éster de 8 carbonos con una vida media de aproximadamente 8 días. Estimula la síntesis proteica y retención de nitrógeno celular.",
  ...
  "testosterone_propionate": {
    "it": {
      ...
      "overview": "Estere di testosterone a catena corta e ad azione rapida. Richiede iniezioni frequenti (a giorni alterni o giornaliere).",
      "mechanism": "Emivita breve di circa 20-36 ore. Rilascia testosterone rapidamente nel flusso sanguigno con minor accumulo di ritenzione idrica.",
    ...
    "de": {
      ...
      "overview": "Kurzkettiger, schnell wirkender Testosteronester. Erfordert häufige Injektionen (jeden 2. Tag oder täglich).",
      "mechanism": "Kurze Halbwertszeit von ca. 20-36 Stunden. Schneller Wirkungseintritt mit geringerer Wassereinlagerung im Vergleich zu langen Estern.",
    ...
    "es": {
      ...
      "overview": "Éster de testosterona de cadena corta y acción rápida. Requiere inyecciones frecuentes (en días alternos o diarias).",
      "mechanism": "Vida media de unas 20-36 horas. Produce una elevación rápida de testosterona plasmática con menor tendencia a retener líquidos.",
  ...
  "drostanolone": {
    "it": {
      ...
      "overview": "Derivato del DHT noto popolarmente come Masteron. Originariamente prescritto per il trattamento del carcinoma mammario femminile.",
      "mechanism": "Non aromatizza in alcun modo e manifesta deboli proprietà anti-estrogeniche. Produce una durezza muscolare marcata ed elimina la ritenzione idrica sottocutanea.",
    ...
    "de": {
      ...
      "overview": "Ein DHT-Derivat, bekannt als Masteron. Ursprünglich zur Behandlung von fortgeschrittenem Brustkrebs bei Frauen verschrieben.",
      "mechanism": "Aromatisiert nicht und wirkt als milder Aromatase-Hemmer/Anti-Östrogen. Verleiht der Muskulatur ein extrem hartes, trockenes Aussehen.",
    ...
    "es": {
      ...
      "overview": "Derivado de la DHT conocido comercialmente como Masteron. Desarrollado originalmente para el tratamiento del cáncer de mama en mujeres.",
      "mechanism": "No aromatiza en absoluto y ejerce un ligero efecto antiestrogénico. Confiere una apariencia sumamente densa, vascular y libre de líquidos.",
  ...
  "methenolone": {
    "it": {
      "name": "Metenolone (Primobolan)",
      "overview": "Uno dei composti anabolizzanti più sicuri e pregiati mai sintetizzati. Spesso considerato il preferito dell'epoca d'oro del bodybuilding.",
      "mechanism": "Rapporto anabolico/androgeno molto favorevole. Non aromatizza e impone uno stress quasi nullo a fegato e profilo cardiovascolare a dosi terapeutiche.",
    ...
    "de": {
      ...
      "overview": "Eines der sichersten und hochwertigsten anabolen Steroide, das je synthetisiert wurde. Gilt als absoluter Favorit der goldenen Ära.",
      "mechanism": "Sehr günstiges anaboles zu androgenes Verhältnis. Aromatisiert nicht und belastet die Leber kaum. Fördert die Stickstoffretention ohne Wasserspeicherung.",
    ...
    "es": {
      ...
      "overview": "Uno de los esteroides anabólicos más seguros y limpios jamás sintetizados. Famoso por ser el favorito en la era dorada del culturismo.",
      "mechanism": "Excelente ratio anabólico/androgénico. No aromatiza en estrógenos y ejerce un impacto hepático mínimo. Promueve retención de nitrógeno pura.",
  ...
  "mesterolone": {
    "it": {
      ...
      "overview": "Derivato orale del DHT non 17-alfa-alchilato. Utilizzato clinicamente per trattare l'ipogonadismo senza provocare una soppressione significativa dell'asse gonadico.",
      "mechanism": "Affinità estrema per la proteina SHBG, liberando elevate quantità di testosterone biodisponibile. Altamente androgeno con anabolismo tissutale debole.",
    ...
    "de": {
      ...
      "overview": "Oral aktives, nicht 17-alpha-alkyliertes DHT-Derivat. Wird klinisch zur Behandlung von Hypogonadismus eingesetzt, ohne die körpereigene Hormonachse stark zu unterdrücken.",
      "mechanism": "Hohe Bindungsaffinität zu SHBG, wodurch freies Testosteron ansteigt. Stark androgen, aber nur schwach anabol.",
    ...
    "es": {
      ...
      "overview": "Derivado oral de DHT no 17-alfa-alquilado. Se utiliza clínicamente para tratar el hipogonadismo sin inducir un bloqueo severo de la producción endógena.",
      "mechanism": "Afinidad muy elevada por la SHBG (globulina fijadora de hormonas sexuales), aumentando drásticamente la fracción libre de testosterona.",
  ...
  "turinabol": {
    "it": {
      "name": "Oral Turinabol (CDMT)",
      "overview": "Originariamente sviluppato nella Germania dell'Est, è stato la spina dorsale del celebre programma statale di doping atletico negli anni '60 e '70.",
      "mechanism": "Sostanzialmente Dianabol a cui è stato aggiunto un atomo di cloro in posizione 4. Questa modifica impedisce totalmente l'aromatizzazione, fornendo guadagni magri senza ritenzione idrica.",
    ...
    "de": {
      "name": "Oral Turinabol",
      "overview": "Ursprünglich in der DDR entwickelt und das Kernstück des staatlich verordneten Dopingprogramms der 1960er und 70er Jahre.",
      "mechanism": "Im Wesentlichen Dianabol mit einer 4-Chlor-Gruppe. Verhindert die Aromatisierung vollständig und sorgt für trockene, fettfreie Muskelmasse ohne Wasserspeicherung.",
    ...
    "es": {
      "name": "Turinabol Oral",
      "overview": "Desarrollado en Alemania Oriental, constituyó el pilar del programa de dopaje estatal en las décadas de 1960 y 1970.",
      "mechanism": "Estructuralmente derivado del Dianabol con una adición de cloro en el carbono 4. Esto bloquea totalmente la aromatización a estrógenos.",
  ...
  "trestolone": {
    "it": {
      ...
      "overview": "Il 7a-metil-19-nortestosterone (MENT) è stato intensamente studiato come contraccettivo maschile sperimentale data la sua capacità di azzerare la produzione di spermatozoi.",
      "mechanism": "Derivato 19-nor ad altissima potenza anabolica. Mostra un'affinità 10 volte superiore rispetto al testosterone nel promuovere la sintesi muscolare.",
    ...
    "de": {
      "name": "Trestolon (MENT)",
      "overview": "Wurde intensiv als potenzielles männliches Verhütungsmittel erforscht, da es die Spermienproduktion drastisch senkt und Testosteron ersetzt.",
      "mechanism": "Ein 19-Nor-Derivat mit extremer Potenz. Wird oft mit der bis zu 10-fachen anabolen Wirkungsstärke von Testosteron beschrieben.",
    ...
    "es": {
      ...
      "overview": "Investigado intensamente como anticonceptivo masculino experimental debido a su capacidad para inhibir totalmente la producción de esperma.",
      "mechanism": "Derivado 19-nor extremadamente potente, con una potencia anabólica calculada en hasta 10 veces la de la testosterona.",
  ...
  "tamoxifen": {
    "it": {
      "name": "Tamoxifene (Nolvadex)",
      "overview": "Un modulatore selettivo dei recettori degli estrogeni (SERM). Rappresenta il gold standard universale per la Post Cycle Therapy (PCT) volta a ripristinare la produzione endogena di testosterone.",
      "mechanism": "Si lega competitivamente ai recettori degli estrogeni nel tessuto mammario, impedendo l'azione dell'estradiolo. Nell'ipofisi inganna il cervello inducendo un massiccio rilascio di LH e FSH.",
    ...
    "de": {
      ...
      "overview": "Ein selektiver Östrogenrezeptor-Modulator (SERM). Der absolute Goldstandard für die Post-Cycle-Therapie (PCT) zur Wiederherstellung der natürlichen Testosteronproduktion.",
      "mechanism": "Bindet kompetitiv an Östrogenrezeptoren im Brustgewebe. Im Gehirn stimuliert es die Hypophyse zur Ausschüttung von LH und FSH.",
    ...
    "es": {
      ...
      "overview": "Un modulador selectivo de los receptores de estrógeno (SERM). Es el estándar de oro para la Terapia Post Ciclo (PCT) orientada a reactivar la producción endógena de testosterona.",
      "mechanism": "Se une competitivamente a los receptores de estrógenos en el tejido mamario. A nivel hipofisario, bloquea el feedback negativo forzando la liberación de LH y FSH.",
  ...
  "anastrozole": {
    "it": {
      "name": "Anastrozolo (Arimidex)",
      "overview": "Un potente inibitore non steroideo dell'aromatasi. È il composto di riferimento prescritto nei protocolli TRT per gestire la conversione dell'eccesso di testosterone in estradiolo.",
      "mechanism": "Si lega reversibilmente all'enzima aromatasi, impedendo la conversione del testosterone in estrogeni e riducendone i livelli circolanti di circa l'80%.",
    ...
    "de": {
      ...
      "overview": "Ein wirksamer, nicht-steroidaler Aromatasehemmer. Der am häufigsten verschriebene Hemmer bei TRT zur Kontrolle des Östrogenspiegels.",
      "mechanism": "Bindet reversibel an das Aromatase-Enzym und blockiert die Umwandlung von Testosteron in Östradiol um ca. 80%.",
    ...
    "es": {
      "name": "Anastrozol (Arimidex)",
      "overview": "Un potente inhibidor de la aromatasa no esteroideo. El fármaco más prescrito en programas de TRT para controlar la conversión excesiva en estrógenos.",
      "mechanism": "Se une de forma reversible a la enzima aromatasa, reduciendo los estrógenos circulantes en aproximadamente un 80%.",
  ...
  "ostarine": {
    "it": {
      ...
      "overview": "Uno dei modulatori selettivi dei recettori degli androgeni (SARM) più ampiamente studiati. Sviluppato specificamente per contrastare il deperimento muscolare e l'osteoporosi.",
      "mechanism": "Si lega in modo selettivo ai recettori degli androgeni nel tessuto muscolare e osseo, inducendo ipertrofia senza interagire negativamente con la prostata.",
    ...
    "de": {
      ...
      "overview": "Einer der am besten erforschten selektiven Androgenrezeptor-Modulatoren (SARMs). Entwickelt zum Schutz vor Muskelschwund bei Krebs und Osteoporose.",
      "mechanism": "Bindet selektiv an Androgenrezeptoren in Muskeln und Knochen, ohne die Prostata nennenswert zu stimulieren oder zu Östrogen zu aromatisieren.",
    ...
    "es": {
      "name": "Ostarina (MK-2866)",
      "overview": "Uno de los moduladores selectivos del receptor de andrógenos (SARM) más exhaustivamente investigados, concebido para prevenir la atrofia muscular.",
      "mechanism": "Se une selectivamente al receptor androgénico en músculo y hueso, activando el crecimiento sin efectos prostáticos negativos ni aromatización.",
  ...
  "ligandrol": {
    "it": {
      ...
      "overview": "Un SARM ad altissima potenza formulato per l'accumulo di massa muscolare. Milligrammo per milligrammo risulta notevolmente più forte dell'Ostarina.",
      "mechanism": "Legame selettivo ad altissima affinità con i recettori degli androgeni nel muscolo scheletrico. Elevata biodisponibilità per via orale.",
    ...
    "de": {
      "name": "Ligandrol (LGD-4033)",
      "overview": "Ein hochpotenter SARM für den gezielten Muskelaufbau. Deutlich stärker als Ostarine bei gleicher Dosierung.",
      "mechanism": "Starke, selektive Bindung an den Androgenrezeptor im Skelettmuskel bei hoher oraler Bioverfügbarkeit.",
    ...
    "es": {
      "name": "Ligandrol (LGD-4033)",
      "overview": "Un SARM sumamente potente diseñado para la hipertrofia muscular. Miligramo por miligramo es mucho más potente que la Ostarina.",
      "mechanism": "Afinidad de unión muy alta y selectiva al receptor androgénico muscular con excelente biodisponibilidad por vía oral.",
  ...
  "rad140": {
    "it": {
      ...
      "overview": "Un SARM avanzato originariamente ideato come alternativa più sicura alla TRT. Noto per donare una muscolatura asciutta e vascolarizzata, simile a Winstrol o Masteron.",
      "mechanism": "Si lega con elevatissima affinità ai recettori degli androgeni muscolari. In alcuni modelli è stato documentato un effetto antagonista verso gli estrogeni nel tessuto mammario.",
    ...
    "de": {
      "name": "Testolone (RAD-140)",
      "overview": "Ein extrem potenter SARM, der ursprünglich als sicherere Alternative zur TRT entwickelt wurde. Sorgt für ein sehr trockenes und vaskuläres Erscheinungsbild.",
      "mechanism": "Bindet aggressiv an muskuläre Androgenrezeptoren. Zeigt in Studien sogar anti-östrogene Tendenzen im Brustgewebe.",
    ...
    "es": {
      ...
      "overview": "Un SARM de alta potencia diseñado originalmente como sustituto seguro de la TRT. Reconocido por conferir una estética muscular seca y vascular parecida a Winstrol.",
      "mechanism": "Unión intensa y selectiva a los receptores androgénicos musculares con capacidad para antagonizar efectos estrogénicos en el tejido mamario.",
  ...
  "semaglutide": {
    "it": {
      ...
      "overview": "Agonista recettoriale del GLP-1. Ha rivoluzionato il trattamento del diabete di tipo 2 e la gestione clinica dell'obesità.",
      "mechanism": "Imita l'ormone incretinico GLP-1, rallentando lo svuotamento gastrico e inviando potenti segnali di sazietà all'ipotalamo.",
      "primaryUses": "Diabete di tipo 2, obesità cronica",
      "dosage": "0.25mg a 2.4mg sottocute una volta a settimana.",
      "benefits": "Perdita di grasso clinicamente documentata, soppressione totale dell'appetito compulsivo, normalizzazione glicemica.",
      "risks": "Nausea, reflusso gastroesofageo, rischio di perdita di massa magra in caso di apporto proteico insufficiente."
    },
    "de": {
      "name": "Semaglutid (Ozempic / Wegovy)",
      "overview": "Ein GLP-1-Rezeptoragonist, der die Behandlung von Typ-2-Diabetes und starkem Übergewicht revolutioniert hat.",
      "mechanism": "Ahmt das körpereigene Sättigungshormon GLP-1 nach, verzögert die Magenentleerung und drosselt den Appetit im Gehirn massiv.",
      "primaryUses": "Typ-2-Diabetes, chronisches Gewichtsmanagement",
      "dosage": "0,25mg bis 2,4mg subkutan einmal wöchentlich.",
      "benefits": "Zuverlässige Fettreduktion, drastische Dämpfung von Heißhungerattacken, optimierte Blutzuckerwerte.",
      "risks": "Übelkeit, Magen-Darm-Beschwerden, möglicher Verlust fettfreier Masse bei proteinarmer Ernährung."
    },
    "es": {
      "name": "Semaglutida (Ozempic / Wegovy)",
      "overview": "Agonista del receptor GLP-1. Ha revolucionado el abordaje del control glucémico en diabetes tipo 2 y el tratamiento de la obesidad clínica.",
      "mechanism": "Mimetiza la acción del péptido GLP-1 intestinal, retrasando el vaciado gástrico y enviando señales directas de saciedad a centros cerebrales.",
      "primaryUses": "Diabetes tipo 2, control de sobrepeso crónico",
      "dosage": "0.25mg a 2.4mg subcutáneo una vez por semana.",
      "benefits": "Pérdida de peso científicamente verificada, supresión radical del apetito compulsivo, mejora de la resistencia a la insulina.",
      "risks": "Náuseas, reflujo, reducción indeseada de tejido magro si no se consume suficiente proteína."
    }
  },
  "tirzepatide": {
    "it": {
      "name": "Tirzepatide (Mounjaro / Zepbound)",
      "overview": "Doppio agonista dei recettori GIP e GLP-1 di ultima generazione. Rappresenta lo standard terapeutico più avanzato al mondo per la perdita di peso.",
      "mechanism": "Attiva sia i recettori GLP-1 che quelli del GIP, massimizzando il controllo della glicemia, il metabolismo lipidico e la soppressione della fame.",
    ...
    "de": {
      ...
      "overview": "Ein dualer GIP- und GLP-1-Rezeptoragonist der neuesten Generation. Gilt weltweit als wirksamstes Medikament zur Gewichtsreduktion.",
      "mechanism": "Aktiviert simultan GIP- und GLP-1-Rezeptoren und potenziert dadurch die Insulinsensitivität und Appetitkontrolle drastisch.",
    ...
    "es": {
      ...
      "overview": "Agonista dual de los receptores GIP y GLP-1. Representa el fármaco de mayor eficacia terapéutica conocido para la reducción de masa grasa.",
      "mechanism": "Actúa de forma sinérgica sobre los receptores GIP y GLP-1, optimizando el metabolismo glucídico y reduciendo el vaciamiento gástrico.",
  ...
  "testosterone_undecanoate": {
    "it": {
      "name": "Testosterone Undecanoato (Nebido / Andriol)",
      "overview": "Un estere di testosterone ad azione straordinariamente prolungata. È unico in quanto può essere somministrato tramite iniezioni distanziate (Nebido) o assunto per via orale (Andriol) tramite assorbimento linfatico.",
      "mechanism": "L'estere undecanoato, estremamente pesante, rallenta notevolmente l'assorbimento. Le forme orali evitano la degradazione epatica assorbendosi attraverso il sistema linfatico anziché la vena porta.",
    ...
    "de": {
      ...
      "overview": "Ein extrem langanhaltender Testosteronester. Kann über seltene Depot-Injektionen (Nebido) oder oral (Andriol) über das Lymphsystem verabreicht werden.",
      "mechanism": "Der schwere Undecanoatester verlangsamt die Aufnahme enorm. Orale Formen umgehen die Leberpassage über das Lymphsystem.",
    ...
    "es": {
      ...
      "overview": "Un éster de testosterona de acción extremadamente prolongada. Se puede administrar mediante inyecciones espaciadas (Nebido) o por vía oral (Andriol) mediante absorción linfática.",
      "mechanism": "El éster undecanoato retrasa enormemente la liberación. Las formulaciones orales eluden el metabolismo de primer paso hepático a través del sistema linfático.",
  ...
  "trenbolone_enanthate": {
    "it": {
      "name": "Trenbolone Enantato",
      "overview": "Una versione a lunga durata d'azione del trenbolone. Progettata per ridurre la frequenza delle iniezioni rispetto all'acetato.",
      "mechanism": "Provvisto dell'estere enantato che ne ritarda il rilascio ematico. Richiede settimane per essere smaltito dall'organismo qualora si manifestino effetti collaterali severi.",
    ...
    "de": {
      ...
      "overview": "Eine langanhaltende Variante von Trenbolon. Entwickelt, um die Injektionshäufigkeit im Vergleich zu Acetat zu reduzieren.",
      "mechanism": "Trägt den Enanthanat-Ester, der die Freisetzung verzögert. Benötigt Wochen zur vollständigen Ausscheidung bei schweren Nebenwirkungen.",
    ...
    "es": {
      ...
      "overview": "Versión de acción prolongada de la trembolona. Formulada para reducir la frecuencia de inyecciones en comparación con el acetato.",
      "mechanism": "Porta el éster enantato, retrasando su liberación en sangre. Tarda semanas en eliminarse por completo si surgen efectos adversos severos.",
  ...
  "trenbolone_parabolan": {
    "it": {
      "name": "Trenbolone Esaidrobenzilcarbonato (Parabolan)",
      "overview": "Il Parabolan è stata l'unica forma di trenbolone mai prodotta ufficialmente per uso umano (in Francia). Veniva prescritto per malnutrizione e osteoporosi prima del ritiro nel 1997.",
      "mechanism": "Dotato dell'estere esaidrobenzilcarbonato, con rilascio equivalente all'enantato. Si lega con affinità estrema ai recettori degli androgeni e del progesterone.",
    ...
    "de": {
      ...
      "overview": "Parabolan war das einzige Trenbolon, das jemals offiziell für den menschlichen Gebrauch (in Frankreich) hergestellt wurde.",
      "mechanism": "Trägt den Hexahydrobenzylcarbonat-Ester. Bindet extrem stark an Androgen- und Progesteronrezeptoren.",
    ...
    "es": {
      ...
      "overview": "Parabolan fue la única forma de trembolona producida oficialmente para uso en humanos (en Francia), recetada para desnutrición severa.",
      "mechanism": "Porta el éster hexahidrobencilcarbonato. Se une potentemente a los receptores de andrógenos y progesterona.",
  ...
  "fluoxymesterone": {
    "it": {
      "name": "Fluossimesterone (Halotestin)",
      "overview": "L'Halotestin è uno degli androgeni orali più potenti e tossici mai creati, impiegato storicamente nel powerlifting per aumentare vertiginosamente forza e aggressività prima di una gara.",
      "mechanism": "Presenta un gruppo fluoro al C-9 e un idrossile al C-11. Si lega con affinità estrema al recettore degli androgeni, generando guadagni colossali di forza senza alcun aumento di peso o ritenzione.",
    ...
    "de": {
      ...
      "overview": "Halotestin ist berühmt als eines der stärksten und toxischsten oralen Androgene überhaupt. Beliebt bei Kraftsportlern zur Maximierung von Kraft und Aggression.",
      "mechanism": "Besitzt eine Fluorgruppe an C-9 und Hydroxyl an C-11. Bindet extrem stark an den AR und bewirkt enorme Kraftsteigerungen ohne Gewichtszunahme.",
  ...
  "exemestane": {
    "it": {
      ...
      "overview": "Un inibitore suicida steroideo dell'aromatasi. A differenza di Arimidex, disattiva permanentemente l'enzima aromatasi prevenendo qualsiasi effetto 'rebound' di estrogeni.",
      "mechanism": "Si lega in modo irreversibile all'enzima aromatasi distruggendone l'attività catalitica. Può aumentare leggermente l'IGF-1 e il testosterone libero.",
      "primaryUses": "Trattamento del cancro al seno, gestione avanzata dell'estradiolo",
      "dosage": "Da 12.5mg a 25mg a giorni alterni o secondo necessità.",
      "benefits": "Nessun rebound di estrogeni alla sospensione; migliore impatto sul profilo lipidico rispetto agli AI non steroidei; stimolazione del testosterone endogeno.",
      "risks": "Dolori articolari in caso di sovradosaggio, demineralizzazione ossea con uso cronico ad alti dosaggi."
    },
    "de": {
      "name": "Exemestan (Aromasin)",
      "overview": "Ein steroidaler Suizid-Aromatasehemmer. Deaktiviert das Aromatase-Enzym dauerhaft, sodass kein Östrogen-Rebound nach dem Absetzen entsteht.",
      "mechanism": "Bindet irreversibel an die Aromatase und zerstört das Enzym. Fördert im Gegensatz zu anderen AIs leicht den IGF-1-Spiegel.",
      "primaryUses": "Brustkrebstherapie, Östrogenkontrolle",
      "dosage": "12,5mg bis 25mg jeden zweiten Tag oder nach Bedarf.",
      "benefits": "Kein Östrogen-Rebound beim Absetzen; geringere Belastung des Cholesterinspiegels als bei Letrozol oder Anastrozol.",
      "risks": "Gelenkschmerzen bei zu starker Östrogensenkung, Erschöpfung."
    },
    "es": {
      "name": "Exemestano (Aromasin)",
      "overview": "Inhibidor de la aromatasa esteroideo de tipo suicida. Inactiva irreversiblemente la enzima aromatasa, evitando rebotes estrogénicos al interrumpir su uso.",
      "mechanism": "Se une covalentemente a la aromatasa anulando su función de forma permanente. Eleva ligeramente los niveles de IGF-1.",
      "primaryUses": "Cáncer de mama, control de estradiol en ciclos",
      "dosage": "12.5mg a 25mg en días alternos según analíticas.",
      "benefits": "Cero rebote de estrógenos; perfil lipídico más favorable que otros inhibidores; ayuda a elevar la testosterona libre.",
      "risks": "Molestias articulares si el estrógeno desciende demasiado, letargo."
    }
  },
  "cabergoline": {
    "it": {
      "name": "Cabergolina (Dostinex)",
      "overview": "Un potente agonista dei recettori della dopamina D2. È il trattamento d'elezione per sopprimere l'eccesso di prolattina indotto da composti 19-nor come Trenbolone e Nandrolone.",
      "mechanism": "Stimola direttamente i recettori dopaminergici nell'ipofisi anteriore, inibendo in modo quasi totale la secrezione di prolattina.",
    ...
    "de": {
      ...
      "overview": "Ein hochpotenter Dopamin-D2-Rezeptoragonist. Das Mittel der Wahl zur Senkung von Prolaktin, insbesondere bei Anwendung von 19-Nor-Steroiden wie Trenbolon oder Deca.",
      "mechanism": "Stimuliert Dopaminrezeptoren in der Hypophyse und hemmt die Prolaktinausschüttung drastisch.",
    ...
    "es": {
      "name": "Cabergolina (Dostinex)",
      "overview": "Agonista potente del receptor de dopamina D2. Fármaco de primera línea para inhibir la prolactina elevada derivada del uso de compuestos 19-nor (Trembolona y Deca).",
      "mechanism": "Activa receptores dopaminérgicos en la hipófisis anterior, suprimiendo de raíz la secreción de prolactina.",
  ...
  "finasteride": {
    "it": {
      ...
      "overview": "Un inibitore selettivo dell'enzima 5-alfa-reduttasi di tipo II. Viene prescritto clinicamente per arrestare la calvizie androgenetica e trattare l'iperplasia prostatica benigna.",
      "mechanism": "Blocca la conversione del testosterone in diidrotestosterone (DHT), abbattendo i livelli sierici di DHT di circa il 70%.",
    ...
    "de": {
      ...
      "overview": "Ein 5-Alpha-Reduktase-Hemmer vom Typ II. Verhindert die Umwandlung von Testosteron in DHT zum Schutz vor erblich bedingtem Haarausfall.",
      "mechanism": "Hemmt das Enzym 5-AR Typ II und senkt den DHT-Spiegel im Serum um ca. 70%.",
    ...
    "es": {
      ...
      "overview": "Inhibidor selectivo de la 5-alfa reductasa tipo II. Recetado extensamente para frenar la alopecia androgenética y tratar la hiperplasia benigna de próstata.",
      "mechanism": "Bloquea la conversión de testosterona a DHT, disminuyendo el DHT circulante en un 70%.",
  ...
  "mk677": {
    "it": {
      ...
      "overview": "Un secretagogo orale non peptidico dell'ormone della crescita. Imita l'azione della grelina, stimolando picchi pulsanti di GH e IGF-1 endogeni.",
      "mechanism": "Si lega ai recettori della grelina (GHSR) nell'ipofisi e nell'ipotalamo, inducendo un aumento duraturo di ormone della crescita e IGF-1 senza sopprimere l'asse gonadico.",
    ...
    "de": {
      "name": "Ibutamoren (MK-677)",
      "overview": "Ein oral bioverfügbarer Wachstumshormon-Sekretagoga. Ahmt das Hungerhormon Ghrelin nach und führt zu kräftigen Pulsen von körpereigenem GH und IGF-1.",
      "mechanism": "Bindet an den Ghrelin-Rezeptor (GHSR) und steigert GH und IGF-1 langanhaltend, ohne die körpereigene Testosteronproduktion zu hemmen.",
    ...
    "es": {
      "name": "Ibutamoren (MK-677)",
      "overview": "Secretagogo oral de hormona de crecimiento. Mimetiza la acción de la grelina, estimulando la secreción pulsátil de GH e IGF-1 endógenos.",
      "mechanism": "Agonista del receptor de grelina en hipófisis. Eleva los niveles de GH e IGF-1 de forma continua sin alterar la producción de testosterona.",
