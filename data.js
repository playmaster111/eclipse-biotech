...
const WIKI_DATA = [
    ...
    {
        id: 'vitamin_d3', folder: 'Micronutrient Optimization', category: 'ancillaries', type: 'Pro-hormone', name: 'Vitamin D3 (Cholecalciferol)', esters: '', status: 'active',
        aka: 'The Sunshine Vitamin, 1,25-dihydroxyvitamin D3',
        overview: 'Technically a secosteroid pro-hormone rather than a vitamin, D3 is essential for the modulation of over 2000 genes. It plays a foundational role in testosterone production, bone health, and immune function.',
        primaryUses: 'Hormonal optimization, bone density, immune modulation',
        mechanism: 'Binds to the Vitamin D Receptor (VDR), which acts as a transcription factor in the nucleus of cells, regulating the expression of genes involved in calcium absorption and steroidogenesis.',
        dosage: '2,000 IU to 5,000 IU daily (standard).',
        experimental: { b: '5,000 IU/day', a: '10,000–50,000 IU/day (with K2)' },
        benefits: 'Significant increase in free testosterone in deficient men, improved insulin sensitivity, and enhanced muscle force production.',
        risks: 'Hypercalcemia (calcium buildup) if taken in extreme doses without Vitamin K2.',
        impact: { brain: -1, heart: -1, liver: 0, kidneys: 1, blood: 0, hair: -1, joints: -2 },
        ...
        storage: { temp: '15-25°C', light: 'Protect from UV', shelf: '24 Months', notes: 'Must be taken with fat for absorption.' }
    },
    {
        id: 'vitamin_c', folder: 'Micronutrient Optimization', category: 'ancillaries', type: 'Antioxidant', name: 'Vitamin C (Ascorbic Acid)', esters: '', status: 'active',
        aka: 'Ascorbate, L-ascorbic acid',
        overview: 'A water-soluble essential nutrient and powerful antioxidant. In the context of performance pharmacology, it is used primarily to manage oxidative stress and suppress excess cortisol production post-training.',
        primaryUses: 'Immune support, collagen synthesis, cortisol management',
        mechanism: 'Acts as an electron donor (reducing agent). It scavenges reactive oxygen species (ROS) and acts as a cofactor for enzymes involved in collagen and catecholamine synthesis.',
        dosage: '500mg to 2,000mg daily.',
        experimental: { b: '1g/day', a: '3g–5g/day (Post-workout)' },
        benefits: 'Accelerated recovery via lower cortisol, improved joint integrity through collagen synthesis, and protection against oxidative damage from androgen use.',
        risks: 'Gastrointestinal distress (diarrhea) at bowel tolerance; potential for kidney stones in predisposed individuals.',
        impact: { brain: -1, heart: 0, liver: 0, kidneys: 1, blood: 0, hair: 0, joints: -1 },
        ...
        storage: { temp: 'RT', light: 'Highly light sensitive', shelf: '18 Months', notes: 'Water soluble; rapid excretion.' }
    },
    {
        id: 'vitamin_b12', folder: 'Micronutrient Optimization', category: 'ancillaries', type: 'Vitamin / Cofactor', name: 'Vitamin B12 (Methylcobalamin)', esters: '', status: 'active',
        aka: 'Methyl-B12, Cobalamin',
        overview: 'A critical B-vitamin involved in red blood cell formation, neurological function, and DNA synthesis. Injectable B12 is a staple in many performance protocols to combat lethargy and stimulate appetite.',
        primaryUses: 'Energy metabolism, neuroprotection, appetite stimulation',
        mechanism: 'Acts as a cofactor for methionine synthase and L-methylmalonyl-CoA mutase. It is essential for the maintenance of the myelin sheath around neurons.',
        dosage: '1,000mcg to 5,000mcg (oral or IM).',
        experimental: { b: '1000mcg/week', a: '1000mcg–5000mcg 3x/week' },
        benefits: 'Profound increase in subjective energy levels, improved cognitive clarity, and stabilization of red blood cell counts during heavy androgen cycles.',
        risks: 'Rare; potentially acne in high doses.',
        impact: { brain: -2, heart: 0, liver: 0, kidneys: 0, blood: -1, hair: 0, joints: 0 },
        ...
        storage: { temp: '15-25°C', light: 'Very light sensitive', shelf: '24 Months' }
    },
    {
        id: 'vitamin_b6_p5p', folder: 'Micronutrient Optimization', category: 'ancillaries', type: 'Vitamin / Cofactor', name: 'Vitamin B6 (P-5-P)', esters: '', status: 'active',
        aka: 'Pyridoxal-5-Phosphate',
        overview: 'P-5-P is the bioactive form of Vitamin B6. In performance pharmacology, it is the primary non-pharmaceutical tool for managing prolactin levels caused by 19-nor steroids (Trenbolone, Nandrolone).',
        primaryUses: 'Prolactin management, neurotransmitter synthesis',
        mechanism: 'Acts as a cofactor for DOPA decarboxylase, increasing the conversion of L-DOPA to Dopamine. Dopamine is the primary inhibitor of prolactin secretion in the pituitary gland.',
        dosage: '50mg to 200mg daily.',
        experimental: { b: '50mg/day', a: '100mg–300mg/day (Prolactin control)' },
        benefits: 'Suppression of prolactin-induced side effects (gynecomastia, ED), improved mood, and better protein metabolism.',
        risks: 'Peripheral neuropathy if taken in extreme doses (typically >500mg/day) for long periods.',
        impact: { brain: -1, heart: 0, liver: 0, kidneys: 0, blood: 0, hair: 0, joints: 0 },
        physiologicalTargets: 'Pituitary gland and amino acid metabolic pathways.',
        synthesis: 'Chemical synthesis from oxazoles.',
        storage: { temp: 'RT', light: 'Protect from light', shelf: '24 Months' }
    },
    {
